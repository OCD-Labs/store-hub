...
SELECT create_review FROM create_review(
  $1,
  $2,
  $3,
  $4,
...
const createReviewFn = `-- name: CreateReviewFn :exec
INSERT INTO reviews (
  store_id,
  user_id,
  item_id,
...
type CreateReviewFnParams struct {
	StoreID            int64  `json:"store_id"`
	UserID             int64  `json:"user_id"`
	ItemID             int64  `json:"item_id"`
	Rating             string `json:"rating"`
...
func (q *Queries) CreateReviewFn(ctx context.Context, arg CreateReviewFnParams) error {
	_, err := q.db.ExecContext(ctx, createReviewFn,
		arg.StoreID,
		arg.UserID,
		arg.ItemID,
		arg.Rating,
